# nvim-treesitter-queries-vhdl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-vhdl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-vhdl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **vhdl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-vhdl",
...
- [ ] Changes are scoped to `vhdl` — do not include files for other languages
